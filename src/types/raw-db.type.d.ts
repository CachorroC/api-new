...
export declare class ConvertRawDb {
    static toRawDb(json: string): RawDb;
    static rawDbToJson(value: RawDb): string;
}
...
export type BancolombiaJuzgadoDepartamento = 'CUNDINAMARCA' | 'BOYACA' | 'ATLANTICO';
export type Resultado291 = 'POSITIVO' | 'ABIERTO' | 'NEGATIVO' | '02/11/2018' | 'N/A';
export type BancolombiaTipoProceso = 'PRENDARIO' | 'SINGULAR' | 'HIPOTECARIO' | 'HIPOTECARO' | 'SINGULAR ';
...
export type OficioNumero = 'EMPLAZAMIENTO' | 'CERTIMAIL' | 'PERSONAL' | 'CORREO' | 'OK' | 'AVISO' | 'CORREO // DESISTIMIENDO DE NELIDA' | 'N/A' | 'FISICA';
...
export type CodeudorTelefonosEnum = 'N/A' | '2067151//3015485509' | '7264921//3203987609' | '5643632//3125598323' | '3118869672' | '3144245852' | '3114472300';
export type FechaCapturaOSecuestro = '     ' | 'A LA ESPERA' | '19/11/2018' | 'N/A';
export type ReintegraJuzgadoDepartamento = 'CUNDINAMARCA' | 'TOLIMA' | 'CUNDINNAMARCA' | 'BOYACÁ' | 'CUNDINAMRCA' | 'CNDINAMARCA';
export type Parqueadero = 'LA PRINCIPAL SAS' | 'N/A';
export type ReintegraTipoProceso = 'PRENDARIO' | 'SINGULAR' | 'HMM PISO 1' | '  SINGULAR' | '5 CME';
...
export type FechaAutoNotificadoEnum = 'N/A' | 'POSITIVO' | 'NEGATIVO' | '9/04/2018' | '10/09/2018' | '21/05/2018' | '08/10/2018' | '|';
export type TerminadoJuzgadoDepartamento = 'CUNDINAMARCA' | 'CUNDINNAMARCA' | 'CUNDINAMARCA ' | 'CUN DINAMARCA' | 'CUNDINNAMARCA ';
export type TerminadoTipoProceso = 'HIPOTECARIO' | 'PRENDARIO' | 'SINGULAR' | 'SINGULAR ACUMULADO CON HIPOTECARIO' | 'SINGULAR ACUM HIPOTECARIO' | 'PRENDARO' | ' HIPOTECARIO' | '7 CME' | 'HIPOTECARIA' | 'SINGULAR ACUMULADO CON HIPOTECARIO CAJA SOCIAL' | 'SOACHA' | 'HIPOTECARIO ' | '18 PROMISCUO PCC';
export declare class Convert {
    static toRawDb(json: string): RawDb;
    static rawDbToJson(value: RawDb): string;
    static toRawWorkSheets(json: string): RawWorkSheets;
    static welcomeToJson(value: RawWorkSheets): string;
    static toBancolombia(json: string): Bancolombia;
    static bancolombiaToJson(value: Bancolombia): string;
    static toInsolvencia(json: string): Insolvencia;
    static insolvenciaToJson(value: Insolvencia): string;
    static toLiosJuridico(json: string): LiosJuridico;
    static liosJuridicoToJson(value: LiosJuridico): string;
    static toReintegra(json: string): Reintegra;
    static reintegraToJson(value: Reintegra): string;
    static toTerminado(json: string): Terminado;
    static terminadoToJson(value: Terminado): string;
}
